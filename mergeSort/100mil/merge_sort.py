...
import psutil
#--------------------------------------Aleatorio------------------------
arq = open('100000Aleatorio.csv', 'r')
final = open('100000Aleatorio.txt', 'w')
...
final.close()
#--------------------------------------Descrescente------------------------
arq = open('100000Decrescente.csv', 'r')
final = open('100000Decrescente.txt', 'w')
...
#--------------------------------------Crescente------------------------
arq = open('100000Crescente.csv', 'r')
final = open('100000Crescente.txt', 'w')
