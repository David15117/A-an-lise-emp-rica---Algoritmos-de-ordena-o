...
arq = open('10000Aleatorio.csv', 'r')
final = open('10000Aleatorio.txt', 'w')
...
arq = open('10000Crescente.csv', 'r')
final = open('10000Crescente.txt', 'w')
...
arq = open('10000Decrescente.csv', 'r')
final = open('10000Decrescente.txt', 'w')
