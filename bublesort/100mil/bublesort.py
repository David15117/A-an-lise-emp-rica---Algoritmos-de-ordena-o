...
#________________________________Aleatorio________________________________________#
arq = open('100000Aleatorio.csv', 'r') # csv
final = open('100000Aleatorio.txt', 'w')#alterar aqui para gerar os resultados para os diferentes algoritmos
...
# ________________________________Descrecente________________________________________#
arq = open('100000Decrescente.csv', 'r')  # csv
final = open('100000Decrescente.txt',
             'w')  # alterar aqui para gerar os resultados para os diferentes algoritmos
...
resultados = ()
inicio = time.time()
resultados = bubbleSort(
    lista)  # depois de gerado o txt com as informações do primeiro algoritmo, altere aqui para gerar as informações sobre os outros algoritmos. Na linha 6 mude o arquivo resultante
fim = time.time()
tempExe = fim - inicio
print(len(lista))
# plt.plot(VTempo)
# plt.title("Tempo gasto por operação")
# plt.show()
final.write("\tBubble Sort\n\nQuantidade de comparações: " + str(resultados[2]) + "\nQuantidade de trocas: " + str(
    resultados[3]) + "\nTempo de execução: " + str(tempExe) + "\nUso da CPU: " + str(
    resultados[0]) + "\nUso de RAM: " + str(resultados[1]) + "\nLista: " + str(resultados[4]))
final.close()

# ________________________________Crescente________________________________________#
arq = open('100000Crescente.csv', 'r')  # csv
final = open('100000Crescente.txt',
             'w')  # alterar aqui para gerar os resultados para os diferentes algoritmos
