...
arq = open('50000Aleatorio.csv', 'r') # csv
final = open('50000Aleatorio.txt', 'w')#alterar aqui para gerar os resultados para os diferentes algoritmos
...
arq = open('50000Decrescente.csv', 'r')  # csv
final = open('50000Decrescente.txt',
...
arq = open('50000Crescente.csv', 'r')  # csv
final = open('50000Crescente.txt',
             'w')  # alterar aqui para gerar os resultados para os diferentes algoritmos
